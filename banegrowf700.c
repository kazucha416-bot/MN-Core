...
int main(void) {
    ...
    // 初期化部分
    fprintf(fp, "d set $lm0n0c0b0m0p0 10 3c23d70a000000000000000000000000000000000000000000000000000000003F800000000000000000000000000000000000000000000000000000000000003F000000000000000000000000000000\n");
