# LJばね問題単精度の修正版コードジェネレータ
# 変更点　：1/massの計算を省略、NR法を4回繰り返すように変更
import os

def main():
    # 設定
    filepath = "/home/kazuki/mncore/1226baneljfloat.vsm"
...
#1/massの配列を作る
d set $lm10n0c0b0m0p0 1 3f80000000000000 # 1/massが求まった こんなのNR法で求めるのあほらしいので省略
nop/2
...
d getf $lb0n0c0b0 {4 * (loop_count+1)}
""")
