...
def main():
    # --- データ定義 ---
    actual_val = 1 / (0.5 ** 0.5)  # 0.5の平方根の逆数の実際の値
    
    data_points = [
        (0, "3ff6800000000000"), # drsqrt
        (1, "3ff6a05800000000"), # 1Newton
        (2, "3ff6a09e6536af66"), # 2Newton
        (3, "3ff6a09e667f3bcd"), # 3Newton
        (4, "3ff6a09e667f3bcc"), # 4Newton
        (5, "3ff6a09e667f3bcc"), # 5Newton
    ]
    ...
    filename = 'newton_error_plot_r=0.5.pdf'  # 画質最強のPDFに変更しておきました！（PNGが良ければ.pngに戻してね）
